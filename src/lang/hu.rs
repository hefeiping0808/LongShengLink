...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Előfordul, hogy bizonyos esetekben hiba léphet fel a Portable verzió használata során. A megfelelő működés érdekében, kérem telepítse a LongShengLink alkalmazást a számítógépre."),
        ...
        ("Configure", "Beállítás"),
        ("config_acc", "A távoli vezérléshez a LongShengLink-nek \"Kisegítő lehetőség\" engedélyre van szüksége"),
        ...
        ("android_input_permission_tip2", "A következő rendszerbeállítások oldalon a letöltött alkalmazások menüponton belül, kapcsolja be a [LongShengLink Input] szolgáltatást."),
        ...
        ("Language", "Nyelv"),
        ("Keep LongShengLink background service", "LongShengLink futtatása a háttérben"),
        ("Ignore Battery Optimizations", "Akkumulátorkímélő figyelmen kívűl hagyása"),
        ("android_open_battery_optimizations_tip", "Ha le szeretné tiltani ezt a funkciót, lépjen a LongShengLink alkalmazás beállítási oldalára, keresse meg az [Akkumulátorkímélő] lehetőséget és válassza a nincs korlátozás lehetőséget."),
        ...
        ("Show LongShengLink", "A LongShengLink megjelenítése"),
        ...
        ("config_input", "Ahhoz, hogy a távoli asztalt a billentyűzettel vezérelhesse, a LongShengLinknek meg kell adnia a \" Bemenet figyelése\" jogosultságot."),
        ("config_microphone", "Ahhoz, hogy távolról beszélhessen, meg kell adnia a LongShengLinknek a \"Hangfelvétel\" jogosultságot."),
        ...
        ("still_click_uac_tip", "A távoli felhasználónak továbbra is a \"Igen\" gombra kell kattintania a LongShengLink UAC ablakában. Kattintson!"),
        ...
        ("verify_rustdesk_password_tip", "LongShengLink jelszó megerősítése"),
        ...
        ("scam_text1", "Ha olyan valakivel beszél telefonon, akit NEM ISMER, akiben NEM BÍZIK MEG, és aki arra kéri, hogy használja a LongShengLinket és indítsa el a szolgáltatást, ne folytassa, és azonnal tegye le a telefont."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Kérjük, frissítse a LongShengLink Server Pro-t a(z) {} vagy újabb verzióra!"),
        ...
        ("selinux_tip", "A SELinux engedélyezve van az eszközén, ami azt okozhatja, hogy a LongShengLink nem fut megfelelően, mint ellenőrzött webhely."),
        ...
        ("powered_by_me", "Üzemeltető: LongShengLink"),
        ("outgoing_only_desk_tip", "Ez a LongShengLink testreszabott kimenete.\nMás eszközökhöz csatlakozhat, de más eszközök nem csatlakozhatnak az Ön eszközéhez."),
        ("preset_password_warning", "Ez egy testreszabott kimenet a LongShengLinkből egy előre beállított jelszóval. Bárki, aki ismeri ezt a jelszót, teljes irányítást szerezhet a készülék felett. Ha nem kívánja ezt megtenni, kérjük, azonnal távolítsa el ezt a szoftvert."),
        ...
        ("allow-only-conn-window-open-tip", "Csak akkor engedélyezze a csatlakozást, ha a LongShengLink ablak nyitva van."),
        ...
        ("floating_window_tip", "Segít, ha a LongShengLink a háttérben fut."),
        ...
        ("About LongShengLink", "A LongShengLinkről"),
