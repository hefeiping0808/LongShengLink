...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Kullanıcı Hesabı Denetimi nedeniyle, LongShengLink bir uzak masaüstü olarak düzgün çalışmayabilir. Bu sorunu önlemek için, LongShengLink'i sistem seviyesinde kurmak için aşağıdaki butona tıklayın."),
        ...
        ("Configure", "Ayarla"),
        ("config_acc", "Masaüstünüzü dışarıdan kontrol etmek için LongShengLink'e \"Erişilebilirlik\""),
        ("config_screen", "Masaüstünüzü dışarıdan kontrol etmek için LongShengLink'e \"Ekran Kaydı\" iznini vermeniz gerekir."),
        ...
        ("android_input_permission_tip1", "Uzak bir cihazın Android cihazınızı fare veya dokunma yoluyla kontrol edebilmesi için, LongShengLink'in \"Erişilebilirlik\" özelliğini kullanmasına izin vermelisiniz."),
        ("android_input_permission_tip2", "Sonraki sistem ayarları sayfasına gidin, [Yüklü Hizmetler]'i bulun ve erişin, [LongShengLink Girişi] hizmetini etkinleştirin."),
        ...
        ("Language", "Dil"),
        ("Keep LongShengLink background service", "LongShengLink arka plan hizmetini sürdürün"),
        ...
        ("Show LongShengLink", "LongShengLink'i Göster"),
        ("This PC", "Bu PC"),
        ("or", "veya"),
        ...
        ("config_input", "Uzaktaki masaüstünü klavye ile kontrol etmek için LongShengLink'e \"Giriş İzleme\" izinleri vermelisiniz."),
        ("config_microphone", "Uzaktan konuşmak için LongShengLink'e \"Ses Kaydı\" izinleri vermelisiniz."),
        ...
        ("still_click_uac_tip", "Uzaktaki kullanıcının çalışan LongShengLink'in UAC penceresinde hala Tamam'ı tıklaması gerekmektedir."),
        ...
        ("verify_rustdesk_password_tip", "LongShengLink parolasını doğrulayın"),
