...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Opretter forbindelse til LongShengLink-netværket..."),
        ...
        ("install_tip", "På grund af UAC kan LongShengLink ikke fungere korrekt i nogle tilfælde på fjernskrivebordet. For at undgå UAC skal du klikke på knappen nedenfor for at installere LongShengLink på systemet"),
        ("Click to upgrade", "Klik for at opgradere"),
        ("Click to download", "Klik for at downloade"),
        ("Click to update", "Klik for at opdatere"),
        ("Configure", "Konfigurer"),
        ("config_acc", "For at kontrollere dit skrivebord på afstand skal du give LongShengLink \"Access \" Rettigheder."),
        ("config_screen", "For at kunne få adgang til dit skrivebord langtfra, skal du give LongShengLink \"skærmstøtte \" tilladelser."),
        ...
        ("android_input_permission_tip1", "For at en ekstern enhed kan kontrollere din Android-enhed via mus eller berøring, skal du give LongShengLink mulighed for at bruge tjenesten \"tilgængelighed \"."),
        ("android_input_permission_tip2", "Gå til den næste systemindstillingsside, søg og indtast [installerede tjenester], tænd for [LongShengLink Input] tjenesten."),
        ...
        ("android_open_battery_optimizations_tip", "Hvis du ønsker at slukke for denne funktion, åbn LongShengLink appens indstillinger, tryk på [Batteri], og fjern flueben ved [Uden begrænsninger]"),
        ...
        ("software_render_tip", "Hvis du bruger et Nvidia grafikkort på Linux, og fjernskrivebordsvinduet lukker ned med det samme efter forbindelsen er oprettet, kan det hjælpe at skifte til Nouveau open-source driveren, og aktivere software rendering. Et genstart af LongShengLink er nødvendigt."),
        ...
        ("config_microphone", "For at tale sammen over fjernstyring, skal du give LongShengLink rettigheder til at optage lyd"),
        ...
        ("still_click_uac_tip", "Kræver stadigvæk at fjernbrugeren skal trykke OK på UAC vinduet ved kørsel af LongShengLink."),
        ...
        ("verify_rustdesk_password_tip", "Bekræft LongShengLink adgangskode"),
        ...
        ("scam_text1", "Hvis du taler telefon med en person du IKKE kender, og IKKE stoler på, som har bedt dig om at bruge LongShengLink til at forbinde til din PC, stop med det samme, og læg på omgående."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Opgradér venligst LongShengLink Server Pro til version {} eller nyere!"),
        ...
        ("selinux_tip", "SELinux er aktiveret på din enhed, som kan forhindre LongShengLink i at køre normalt."),
        ...
        ("powered_by_me", "Drives af LongShengLink"),
        ...
        ("preset_password_warning", "Denne brugertilpassede udgave har en forudbestemt adgangskode. Alle der kender til denne adgangskode, kan få fuld adgang til din enhed. Hvis du ikke forventede dette, bør du afinstallere denne udgave af LongShengLink med det samme."),
        ...
        ("allow-only-conn-window-open-tip", "Tillad kun fjernforbindelser hvis LongShengLink vinduet er synligt"),
        ...
        ("floating_window_tip", "Det hjælper på at LongShengLink baggrundstjenesten kører"),
        ...
        ("About LongShengLink", "Om LongShengLink"),
