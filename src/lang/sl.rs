...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem LongShengLink..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, LongShengLink v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Click to download", "Klikni za prenos"),
        ("Click to update", "Klikni za posodobitev"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate LongShengLinku dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate LongShengLinku dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno LongShengLinku dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »LongShengLink Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep LongShengLink background service", "Ohrani LongShengLinkovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije LongShengLink, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "Za nadzor oddaljenega namizja s tipkovnico, rabi LongShengLink pravico »Nadzor vnosa«."),
        ("config_microphone", "Za zajem zvoka, rabi LongShengLink pravico »Snemanje zvoka«."),
        ...
        ("verify_rustdesk_password_tip", "Preveri geslo za LongShengLink"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite LongShengLink, prekinite klic in program zaprite."),
        ("scam_text2", "LongShengLink omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Prosimo, nadgradite LongShengLink Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo LongShengLink"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno LongShengLinka odprto"),
        ...
        ("floating_window_tip", "Pomaga pri LongShengLink storitvi v ozadju"),
        ...
        ("About LongShengLink", "O LongShengLinku"),
