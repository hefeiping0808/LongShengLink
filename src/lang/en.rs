...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the LongShengLink network..."),
        ...
        ("install_tip", "Due to UAC, LongShengLink can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install LongShengLink to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant LongShengLink \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant LongShengLink \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow LongShengLink to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [LongShengLink Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next LongShengLink application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant LongShengLink \"Input Monitoring\" permissions."),
        ("config_microphone", "In order to speak remotely, you need to grant LongShengLink \"Record Audio\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running LongShengLink."),
        ...
        ("verify_rustdesk_password_tip", "Verify LongShengLink password"),
        ...
        ("scam_text1", "If you are on the phone with someone you DON'T know AND TRUST who has asked you to use LongShengLink and start the service, do not proceed and hang up immediately."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Please upgrade LongShengLink Server Pro to version {} or newer!"),
        ...
        ("selinux_tip", "SELinux is enabled on your device, which may prevent LongShengLink from running properly as controlled side."),
        ...
        ("powered_by_me", "Powered by LongShengLink"),
        ...
        ("allow-only-conn-window-open-tip", "Only allow connection if LongShengLink window is open"),
