...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "LongShengLink może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować LongShengLink w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić LongShengLink przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić LongShengLink na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [LongShengLink Input]."),
        ...
        ("Language", "Język"),
        ("Keep LongShengLink background service", "Zachowaj usługę LongShengLink w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji LongShengLink, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show LongShengLink", "Pokaż LongShengLink"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji LongShengLink uprawnień do \"Urządzeń Wejściowych\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z LongShengLink w Twojej sieci."),
        ...
        ("verify_rustdesk_password_tip", "Weryfikuj hasło LongShengLink"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu LongShengLink - nie rób tego i natychmiast się rozłącz."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Proszę zaktualizować LongShengLink Server Pro do wersji {} lub nowszej!"),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu LongShengLink po stronie kontrolowanej."),
        ...
        ("powered_by_me", "Obsługiwane przez LongShengLink"),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno LongShengLink jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę LongShengLink w tle"),
        ...
        ("About LongShengLink", "O programie"),
