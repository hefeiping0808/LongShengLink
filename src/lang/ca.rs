...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "S'està connectant a la xarxa de LongShengLink..."),
        ...
        ("install_tip", "En alguns casos és possible que el LongShengLink no funcioni correctament per les restriccions UAC («User Account Control»; Control de comptes d'usuari). Per evitar aquest problema, instal·leu el LongShengLink al vostre sistema."),
        ...
        ("Configure", "Configura"),
        ("config_acc", "Per a poder controlar el dispositiu remotament, faciliteu al LongShengLink els permisos d'accessibilitat."),
        ("config_screen", "Per a poder controlar el dispositiu remotament, faciliteu al LongShengLink els permisos de gravació de pantalla."),
        ...
        ("android_input_permission_tip1", "Per a controlar de forma remota el vostre dispositiu amb gestos o un ratolí, heu de permetre al LongShengLink l'ús del servei «Accessibilitat»."),
        ("android_input_permission_tip2", "A l'apartat Configuració del sistema de la pàgina següent, aneu a «Serveis baixats», i activeu el «LongShengLink Input»."),
        ...
        ("Language", "Idioma"),
        ("Keep LongShengLink background service", "Manté el servei del LongShengLink en rerefons"),
        ("Ignore Battery Optimizations", "Ignora les optimitzacions de bateria"),
        ("android_open_battery_optimizations_tip", "Si voleu desactivar aquesta característica, feu-ho des de la pàgina següent de configuració del LongShengLink, utilitzant l'opció relativa a «Bateria»"),
        ...
        ("elevated_foreground_window_tip", "La finestra de connexió actual requereix permisos ampliats per a funcionar i, de forma temporal, no es pot utilitzar ni el teclat ni el ratolí. Demaneu a l'usuari remot que minimitzi la finestra actual, o bé que faci clic al botó Permisos ampliats de la finestra d'administració de la connexió. Per a evitar aquest problema en un futur, instal·leu el LongShengLink al dispositiu remot."),
        ...
        ("Show LongShengLink", "Mostra el LongShengLink"),
        ...
        ("config_input", "Per a poder controlar el dispositiu remotament amb el teclat, faciliteu al LongShengLink els permisos d'entrada necessaris."),
        ("config_microphone", "Per a poder parlar remotament, faciliteu al LongShengLink els permisos de gravació d'àudio necessaris."),
        ...
        ("still_click_uac_tip", "Es requereix acceptació manual a la part remota de la finestra «UAC» del LongShengLink en execució."),
        ...
        ("verify_rustdesk_password_tip", "Verifica la contrasenya del LongShengLink"),
        ...
        ("scam_text1", "Si cap persona qui NO coneixeu NI CONFIEU us demanés l'ús del LongShengLink, no continueu i talleu la comunicació immediatament."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Actualitzeu el LongShengLink Server Pro a la versió {} o superior!"),
        ...
        ("selinux_tip", "SELinux està activat al vostre dispositiu, la qual cosa evita que el LongShengLink funcioni correctament com a equip controlable."),
        ...
        ("powered_by_me", "Amb la tecnologia de LongShengLink"),
        ...
        ("allow-only-conn-window-open-tip", "Permet la connexió només si la finestra del LongShengLink està activa"),
        ...
        ("floating_window_tip", "Ajuda a mantenir el servei del LongShengLink en rerefons"),
        ...
        ("About LongShengLink", "Quant al LongShengLink"),
