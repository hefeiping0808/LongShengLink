...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do LongShengLink..."),
        ...
        ("install_tip", "Devido ao UAC, o LongShengLink não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o LongShengLink no sistema."),
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao LongShengLink permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao LongShengLink permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o LongShengLink use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [LongShengLink Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep LongShengLink background service", "Manter o serviço do LongShengLink executando em segundo plano"),
        ...
        ("Show LongShengLink", "Exibir LongShengLink"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do LongShengLink."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do LongShengLink."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do LongShengLink."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do LongShengLink"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o LongShengLink e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o LongShengLink Server Pro para a versão {} ou superior."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o LongShengLink funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por LongShengLink"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do LongShengLink estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço LongShengLink em segundo plano"),
        ...
        ("About LongShengLink", "Sobre LongShengLink"),
