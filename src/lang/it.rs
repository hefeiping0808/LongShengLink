...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete LongShengLink..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), LongShengLink potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare LongShengLink a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Click to download", "Download"),
        ("Click to update", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a LongShengLink il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a LongShengLink il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a LongShengLink di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [LongShengLink Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep LongShengLink background service", "Mantieni il servizio di LongShengLink in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione LongShengLink, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show LongShengLink", "Visualizza LongShengLink"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a LongShengLink 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a LongShengLink."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di LongShengLink."),
        ...
        ("verify_rustdesk_password_tip", "Conferma password LongShengLink"),
        ...
        ("Exit", "Esci da LongShengLink"),
        ("Open", "Apri LongShengLink"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare LongShengLink e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aggiorna LongShengLink Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di LongShengLink come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da LongShengLink"),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra LongShengLink è aperta"),
        ...
        ("floating_window_tip", "It helps to keep LongShengLink background service"),
        ...
        ("About LongShengLink", "Info su LongShengLink"),
