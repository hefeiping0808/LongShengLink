...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", ""),
        ("Established", ""),
        ("connecting_status", "LongShengLinki võrguga ühendumine..."),
        ("Enable service", ""),
        ("Start service", ""),
        ("Service is running", ""),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa LongShengLink mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et LongShengLink oma süsteemi paigaldada."),
        ("Click to upgrade", ""),
        ("Click to download", ""),
        ("Click to update", ""),
        ("Configure", ""),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb LongShengLinkile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb LongShengLinkile anda \"ekraanisalvestuse\" õigused."),
        ("Installing ...", ""),
        ("Install", ""),
        ("Installation", ""),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma LongShengLinkile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [LongShengLink Input] sisse."),
        ...
        ("Turned off", ""),
        ("Language", ""),
        ("Keep LongShengLink background service", ""),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele LongShengLinki rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ("Start on boot", ""),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma LongShengLinkile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma LongShengLinkile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud LongShengLinki kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_rustdesk_password_tip", "Kinnita LongShengLinki parooli"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul LongShengLinki kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Palun täienda LongShengLink Server Pro versioonile {} või uuem!"),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib LongShengLinkil takistada juhitud poolel toimimist."),
        ("Change view", ""),
        ("Big tiles", ""),
        ("Small tiles", ""),
        ("List", ""),
