...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till LongShengLink..."),
        ...
        ("install_tip", "På grund av UAC, kan inte LongShengLink fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera LongShengLink på systemet."),
        ...
        ("config_acc", "För att kontrollera din dator på distans måste du ge LongShengLink \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge LongShengLink \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [LongShengLink Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep LongShengLink background service", "Behåll LongShengLink i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa LongShengLink programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ("Start on boot", ""),
        ...
        ("Show LongShengLink", "Visa LongShengLink"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
