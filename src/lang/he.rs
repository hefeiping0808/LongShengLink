...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", ""),
        ("Established", ""),
        ("connecting_status", "מתחבר לרשת LongShengLink..."),
        ("Enable service", ""),
        ("Start service", ""),
        ("Service is running", ""),
        ...
        ("install_tip", "בגלל UAC, LongShengLink לא יכול לפעול כראוי כצד מרוחק בחלק מהמקרים. כדי להימנע מ-UAC, אנא לחץ על הכפתור למטה כדי להתקין את LongShengLink במערכת."),
        ("Click to upgrade", ""),
        ("Click to download", ""),
        ("Click to update", ""),
        ("Configure", ""),
        ("config_acc", "כדי לשלוט מרחוק בשולחן העבודה שלך, עליך להעניק ל-LongShengLink הרשאות \"נגישות\"."),
        ("config_screen", "כדי לגשת מרחוק לשולחן העבודה שלך, עליך להעניק ל-LongShengLink הרשאות \"הקלטת מסך\"."),
        ("Installing ...", ""),
        ("Install", ""),
        ("Installation", ""),
        ...
        ("android_input_permission_tip1", "כדי שמכשיר מרוחק יוכל לשלוט במכשיר האנדרואיד שלך באמצעות עכבר או מגע, עליך לאפשר ל-LongShengLink להשתמש בשירות \"נגישות\"."),
        ("android_input_permission_tip2", "אנא עבור לדף ההגדרות של המערכת הבא, מצא והכנס ל[שירותים מותקנים], הפעל את שירות [LongShengLink Input]."),
        ...
        ("android_open_battery_optimizations_tip", "אם ברצונך לבטל תכונה זו, אנא עבור לדף ההגדרות של יישום LongShengLink הבא, מצא והכנס ל[סוללה], הסר את הסימון מ-[לא מוגבל]"),
        ("Start on boot", ""),
        ...
        ("config_input", "כדי לשלוט בשולחן העבודה המרוחק באמצעות מקלדת, עליך להעניק ל-LongShengLink הרשאות \"מעקב אחרי קלט\"."),
        ("config_microphone", "כדי לדבר מרחוק, עליך להעניק ל-LongShengLink הרשאות \"הקלטת שמע\"."),
        ...
        ("still_click_uac_tip", "עדיין דורש מהמשתמש המרוחק ללחוץ OK בחלון ה-UAC של הרצת LongShengLink."),
        ...
        ("verify_rustdesk_password_tip", "אמת סיסמת LongShengLink"),
        ...
        ("scam_text1", "אם אתה בשיחת טלפון עם מישהו שאינך מכיר ואינך סומך עליו שביקש ממך להשתמש ב-LongShengLink ולהתחיל את השירות, אל תמשיך ונתק מיד."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "אנא שדרג את LongShengLink Server Pro לגרסה {} או חדשה יותר!"),
        ...
        ("selinux_tip", "SELinux מופעל במכשיר שלך, מה שעלול למנוע מ-LongShengLink לפעול כראוי כצד הנשלט."),
        ("Change view", ""),
        ("Big tiles", ""),
        ("Small tiles", ""),
        ("List", ""),
